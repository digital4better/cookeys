...
<div>
  <b-card class="exercise"
    ...
    header="Exercice 5"
    footer-tag="footer"
    title="Saisis les caractères suivants :"
    ...
    <section class=body>
      ...
      <div><input class="input" type="text" v-model="value" @input="checkLetter" @change="stopSpeech" :disabled="success" aria-hidden="true" v-focus></div>
      <div>
